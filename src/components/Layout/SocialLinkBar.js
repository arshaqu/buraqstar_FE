...
const SocialLinkBar = () => {
  ...
  return (
    <Box className="w-full flex justify-center flex-col md:flex-row social-bar md:justify-start items-center text-white bg-[#2858a3] h-fit gap-x-5 gap-y-2 md:gap-y-0 py-3 md:py-0 text-xs md:text-sm md:h-11">
      <style>{`
      ...
      <Box className="hidden md:w-1/2 w-full md:flex gap-x-8 justify-center items-center h-full">
      ...
      <Box className="md:w-1/2 w-full flex justify-center items-center h-full ipad-right-section">
        ...
        <Box className="hidden md:flex items-center gap-x-8 border-r-2 border-white md:pe-8 sm:pe-5 pe-0 ipad-store-wishlist">
          ...
          <Box className="flex gap-x-2 cursor-pointer items-center" onClick={handleNavigate}>
            ...
            <Typography className="capitalize text-xs poppins">{t("wishlist")}</Typography>
          </Box>
        </Box>
        ...
        <Box className="flex items-center gap-x-3 md:gap-x-5 md:ps-5 ipad-selectors-container">
          ...
          <Box className="relative" ref={currencyRef}>
            <Button 
              className="flex items-center text-white poppins text-xs min-w-0 px-2 md:px-3 py-1 rounded-lg transition-all duration-200 gap-1"
            ...
            >
              <Typography className="text-xs font-medium">{getCurrencySymbol(currency)}</Typography>
              <Typography className="text-xs font-medium">{currency}</Typography>
            ...
            {openCurrency && (
              ...
              >
                {["AED", "EUR", "USD"].map((curr, i) => (
                  ...
                  >
                    <Typography className="text-xs font-medium">{getCurrencySymbol(curr)}</Typography>
                    <Typography className="text-xs font-medium">{curr}</Typography>
                  </Box>
                ))}
              </Box>
            )}
          ...
          <Box className="relative" ref={languageRef}>
            <Button 
              className="flex items-center text-white text-xs min-w-0 px-2 md:px-3 py-1 rounded-lg transition-all duration-200 gap-1" 
            ...
            >
              ...
              <Typography className="poppins text-xs font-medium">{language}</Typography>
                ...
                {[
                  ...
                  >
                    ...
                    <Box className="flex flex-col items-start">
                      <Typography className="text-xs font-medium leading-tight">{lang.code}</Typography>
