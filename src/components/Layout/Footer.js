...
import footer_logo from "./../../assets/buraqfooterlogo.png";
...
const Footer = () => {
  ...
  return (
    <Box
      dir={isRTL ? "rtl" : "ltr"}
      className="w-full h-fit bg-cover bg-no-repeat bg-center p-8 md:p-10 lg:p-20 lg:pb-8 md:pb-8 pb-3 bg-[#2858A3] "
    >
      <style>{`
      ...
      <Grid container>
          ...
          <Box className="flex justify-center sm:justify-start">
            <Link to="/" onClick={handleLogoClick} style={{ cursor: 'pointer' }}>
              <img
                ...
                className="h-[18vh] w-auto text-center"
              />
            </Link>
          </Box>
          <Typography className="text-[10px] mt-7 mb-4 w-[95%] text-white font-semibold poppins text-center md:text-start footer-text-ipad ipad-description">
            {t("footer.description")}
          </Typography>
          <Box className="flex flex-row ipad-subscribe-container">
            <input
              type="text"
              className="bg-white rounded-md py-2.5 px-4 w-[65%] text-sm footer-text-ipad"
              placeholder={t("footer.your_email")}
              value={email}
              onChange={(e) => setEmail(e.target.value)}
            />
            <Button
              className="text-white bg-[#FF3030] capitalize poppins py-2.5 px-4 ms-2 text-sm w-[30%] md:w-[auto] hover:bg-[#E02828] transition-colors duration-300 disabled:opacity-50 footer-text-ipad ipad-subscribe-button"
        ...
        <Grid item xs={12} sm={4} className="flex text-center sm:text-start flex-col sm:flex-row justify-center items-center sm:items-start sm:justify-between mb-2 sm:mb-0">
          ...
          <Box className="sm:hidden w-full flex items-center justify-center gap-2 mb-4 ml-8">
            <Typography className="text-2xl text-white poppins font-semibold footer-text-ipad">
          ...
          <Box className={`w-full ${quickLinksOpen ? 'flex flex-col' : 'hidden'} sm:flex sm:flex-row sm:justify-between ipad-quick-links`}>
            {footerLinks.map((links, i) => (
              <Box
                className={`w-full sm:w-1/2 text-white gap-y-4 font-semibold text-sm flex flex-col text-center sm:text-start ${i === 1 && "ps-0 sm:ps-5"} ${i === 1 && "mt-3.5 sm:mt-0"} poppins footer-text-ipad ipad-links-text`}
                key={i}
              >
                <Link to={links.link} className="footer-text-ipad ipad-links-text">{t(`footer_links.${links.title}`)}</Link>
        ...
        <Grid item xs={12} sm={3} className="mb-2 sm:mb-0">
          ...
          <Box className="sm:hidden w-full flex items-center justify-center gap-2 mb-4 ml-4">
            <Link to={routes.contact} className="text-2xl text-white poppins font-semibold footer-text-ipad">
              {t("footer.contact_us")}
            </Link>
            <IconButton
          ...
          <Box
            className={`w-full text-white gap-y-4 font-semibold text-sm flex flex-col justify-center items-center sm:justify-start sm:items-start poppins ${contactUsOpen ? "flex" : "hidden"} sm:flex ipad-links-text`}
          >
            {/* Desktop Contact Us heading */}
            <Link to={routes.contact} className="hidden sm:block text-sm footer-text-ipad ipad-links-text">{t("footer.contact_us")}</Link>
            <Link className="flex gap-x-2 items-start footer-text-ipad ipad-links-text" to={routes.storeLocator} style={{ cursor: "pointer" }}>
              <LocationOnOutlinedIcon className="text-sm footer-text-ipad ipad-links-text shrink-0" />
              <Typography className="text-sm poppins font-semibold text-center md:text-start footer-text-ipad ipad-links-text">
                {t("footer.address")}
              </Typography>
            </Link>
            <a className="flex gap-x-2 items-start footer-text-ipad ipad-links-text" href="tel:80066839">
              <LocalPhoneOutlinedIcon className="text-sm footer-text-ipad ipad-links-text shrink-0" />
              <Typography className="text-sm poppins font-semibold footer-text-ipad ipad-links-text">
                800-NOVEX (66839)
              </Typography>
            </a>
            <a className="flex gap-x-2 items-start footer-text-ipad ipad-links-text" href="tel:+971562670681">
              <LocalPhoneOutlinedIcon className="text-sm footer-text-ipad ipad-links-text shrink-0" />
              <Typography className="text-sm poppins font-semibold footer-text-ipad ipad-links-text">
                +971 562670681
              </Typography>
            ...
            <a className="flex gap-x-2 items-start footer-text-ipad ipad-links-text" href="mailto:ecommerce@buraqstar.com">
              <EmailOutlinedIcon className="text-sm footer-text-ipad ipad-links-text shrink-0" />
              <Typography className="text-sm poppins font-semibold footer-text-ipad ipad-links-text">
                ecommerce@buraqstar.com
              </Typography>
            </a>
            <Typography className="text-sm poppins font-semibold pt-0 sm:pt-4 footer-text-ipad ipad-links-text">
              {t("footer.service_time")}
            </Typography>
            <Box className="flex gap-x-2 items-start">
              <AccessTimeOutlinedIcon className="text-sm footer-text-ipad ipad-links-text shrink-0" />
              <Typography className="text-sm poppins font-semibold footer-text-ipad ipad-links-text">
                {t("footer.timings")}
              </Typography>
            </Box>
        ...
        <Grid
          ...
          xs={12}
          sm={5}
          className="h-fit sm:h-[21vh] flex justify-center sm:justify-start items-end pt-0 sm:pt-6 pb-2 sm:pb-0 mb-6 sm:mb-0 ipad-last-row"
        >
          <Typography className="text-sm poppins text-white font-semibold pt-0 sm:pt-4 text-center md:text-start footer-text-ipad ipad-copyright">
            {t("footer.copyright")}
          </Typography>
        </Grid>
        <Grid
          ...
          xs={12}
          sm={4}
          className="h-fit sm:h-[21vh] flex justify-center sm:justify-start items-end gap-x-2 pt-0 pb-2 sm:py-0 mb-6 sm:mb-0 ipad-last-row ipad-social-icons"
        >
          {footerSocials.map((social, i) => (
            <Link target="_blank" to={social.link} key={i} className="text-sm text-white footer-text-ipad">
              {social.icon}
            </Link>
          ))}
        </Grid>
        <Grid
          ...
          xs={12}
          sm={3}
          className="h-fit sm:h-[21vh] flex items-end justify-center sm:justify-start pt-0 pb-2 sm:py-0 ipad-last-row"
        >
          <img
            src={footer_payments}
      ...
      <div className="whatsapp">
        <a href="https://api.whatsapp.com/send?phone=+971562670681" target="_blank" rel="noreferrer" className="whatsapp-fixed">
